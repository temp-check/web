...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference("Search.count") do
      post searches_url, params: { search: { address: @search.address, data: @search.data, error: @search.error } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { address: @search.address, data: @search.data, error: @search.error } }
